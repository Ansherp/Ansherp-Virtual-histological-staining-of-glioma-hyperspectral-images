...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        # for generator
        self.parser.add_argument('--netG', type=str, default='UNet_Usual', help='selects model to use for netG [UNet][global][encoder][local][DinkNet34][HRnet][UNet_Usual][UNet_Usual3D]')
        self.parser.add_argument('--ngf', type=int, default=32, help='# of gen filters in first conv layer')
        self.parser.add_argument('--conv_nd', type=int, default=2, help='# of gen filters conv_nd[conv2d]|[conv3d]')
        ...
        self.parser.add_argument('--dir_data_A', type=str, default='')
        self.parser.add_argument('--dir_data_B', type=str, default='')

        self.parser.add_argument('--custom_chs', type=int, nargs='+', default=[])

        self.parser.add_argument('--no_resie_crop', action='store_true',
                                 help='store_true pre resize hou crop ')

        self.parser.add_argument('--bg', action='store_true')
        self.parser.add_argument('--bg_list', type=int, default=[10.6289, 28.9782, 104.0634, 159.9853, 98.0708, 91.0175, 11.2228], help='spectrum background gray mean value')
