...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--HE_loss', action='store_true', help='if specified, do *not* use VGG feature matching loss')
        self.parser.add_argument('--npy_random', action='store_true', help='对npy文件随机抽取其中一个通道传入网络训练')
